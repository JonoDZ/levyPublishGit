...
$(window).bind('load', function () {
	...
	function parallaxInit() {
		...
		$('#quote-parallax1').parallax("30%", 0.1);
		$('#quote-parallax2').parallax("30%", 0.1);
		$('#quote-parallax3').parallax("30%", 0.1);
...
//}
 ...
 map = new google.maps.Map(document.getElementById("map_canvas"),
	...
	var companyPos = new google.maps.LatLng(51.750617,-0.3397426);
	...
	var companyPos2 = new google.maps.LatLng(52.3111339,4.9462308);
